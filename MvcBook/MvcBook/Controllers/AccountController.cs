...
namespace MvcBook.Controllers {
   ...
   public class AccountController : Controller {
      ...
      } //close AccountController() default constructor
      ...
      } //close AccountController(...) 2 parameter constructor
      ...
      public ActionResult ForgotPasswordConfirmation() {
         return View();
      }//close ForgotPasswordConfirmation()
      ...
      public ActionResult ResetPasswordConfirmation() {
         return View();
      }//close ResetPasswordConfirmation()
      ...
      public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel
       model, string returnUrl) {
         ...
         ViewBag.ReturnUrl = returnUrl;
         return View(model);
      }//close ExternalLoginConfirmation(...)
